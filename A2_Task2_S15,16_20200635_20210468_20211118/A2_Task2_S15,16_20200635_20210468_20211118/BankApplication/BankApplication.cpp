...
BankApplication::BankApplication()
{
	...
	case 1: cout << "Please Enter Client Name: "; getline(cin, name); client.setName (name);
			cout << "Please Enter Client Address: "; getline(cin, adress); client.setAdress (adress);
			cout << "Please Enter Client Phone: "; cin >> phone; client.setPhone (phone);
			cout << "What Type of Account Do You Like ? (1) Basic(2) Saving – Type 1 or 2:\n ";
			int input; cin >> input;
			if (input == 1) {
				cout << "Please Enter the Starting Balance: "; cin >> StartingBalance; setBalance (StartingBalance);
                BankAcoount newAccount;
				cout << "An account was created with ID " << ID << " and Starting Balance " << StartingBalance << " L.E.\n";
			}
			else if (input == 2) {
				...
				SabingBankAccount NewSavingBankAccount;
	...
	case 2: cout << "------------- " << client.getName () << "---------\n";
            ...
            cout << "Account ID: " << account.getID << "( " << account.getType << " )" << endl;
